...
<%
    ...
    try {
        ...
        String query28 = "CREATE TABLE `Decomm_Manage_Service_Categories_Checklist_others`(`prj_name` varchar(255) DEFAULT NULL, `app_name` varchar(255) DEFAULT NULL,`others`varchar(255) DEFAULT NULL, `questions` varchar(600) DEFAULT NULL, `type` varchar(255) DEFAULT NULL,`value` varchar(600) DEFAULT NULL,`level` INTEGER(255) DEFAULT NULL, `sub_seq` INTEGER(255) DEFAULT NULL, `dev` varchar(255), `test` varchar(255), `stage` varchar(255), `prod` varchar(255)) ";
