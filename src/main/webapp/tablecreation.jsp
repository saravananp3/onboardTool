...
<%
    ...
    try {
        ...
        String query20 = "CREATE TABLE `Decomm_Intake_req` (`prj_name` varchar(100) DEFAULT NULL, `app_name` varchar(100) DEFAULT NULL, `legacy_app_name` varchar(255) DEFAULT NULL,  `enterprise_team_decomm_prj_no` varchar(225) DEFAULT NULL, `app_identification_no` varchar(100) DEFAULT NULL, `infra_prj_no` varchar(255) DEFAULT NULL, `read_only_date` varchar(255) DEFAULT NULL)";
        statement.executeUpdate(query20);
        String query21 = "CREATE TABLE `Decomm_BusinessUnit_GeograaphicCode`(`prj_name` varchar(255) DEFAULT NULL, `app_name`varchar(255) DEFAULT NULL, `business_unit` varchar(255) DEFAULT NULL, `operation_unit` varchar(255) DEFAULT NULL, `location_unit` varchar(255) DEFAULT NULL, `dept` varchar(255) DEFAULT NULL)";
        statement.executeUpdate(query21);
        String query22 = "CREATE TABLE `Decomm_SiteLoaction_Assets`(`prj_name` varchar(255) DEFAULT NULL, `app_name`varchar(255) DEFAULT NULL, `country` varchar(255) DEFAULT NULL, `city` varchar(255) DEFAULT NULL, `state` varchar(255) DEFAULT NULL, `office_designation` varchar(255) DEFAULT NULL)";
