...
<%
    ...
    try {
        ...
        String query10 = "CREATE TABLE `Admin_UserDetails` ( `uname` varchar(255) DEFAULT NULL, `fname` varchar(255) DEFAULT NULL, `lname` varchar(255) DEFAULT NULL, `email` varchar(255) DEFAULT NULL, `pwd` varchar(255) DEFAULT NULL, `projects` varchar(255) DEFAULT NULL, `roles` varchar(255) DEFAULT NULL, `stats` varchar(255) DEFAULT NULL, `question` varchar(255) DEFAULT NULL, `answer` varchar(255) DEFAULT NULL, `application` varchar(255) DEFAULT NULL,`id` int(11) NOT NULL AUTO_INCREMENT,PRIMARY KEY (`id`) )";
        ...
        String query20 = "CREATE TABLE `Decomm_Intake_req` (`id` varchar(255) DEFAULT NULL, `prj_name` varchar(100) DEFAULT NULL, `app_name` varchar(100) DEFAULT NULL, `legacy_app_name` varchar(255) DEFAULT NULL,  `enterprise_team_decomm_prj_no` varchar(225) DEFAULT NULL, `app_identification_no` varchar(100) DEFAULT NULL, `infra_prj_no` varchar(255) DEFAULT NULL, `read_only_date` varchar(255) DEFAULT NULL)";
        statement.executeUpdate(query20);
        String query21 = "CREATE TABLE `Decomm_BusinessUnit_GeographicCode`(`id` varchar(255) DEFAULT NULL, `prj_name` varchar(255) DEFAULT NULL, `app_name`varchar(255) DEFAULT NULL, `business_unit` varchar(255) DEFAULT NULL, `operation_unit` varchar(255) DEFAULT NULL, `location_unit` varchar(255) DEFAULT NULL, `dept` varchar(255) DEFAULT NULL)";
        statement.executeUpdate(query21);
        String query22 = "CREATE TABLE `Decomm_SiteLocation_Assets`(`id` varchar(255) DEFAULT NULL, `prj_name` varchar(255) DEFAULT NULL, `app_name`varchar(255) DEFAULT NULL, `country` varchar(255) DEFAULT NULL, `city` varchar(255) DEFAULT NULL, `state` varchar(255) DEFAULT NULL, `office_designation` varchar(255) DEFAULT NULL)";
        ...
        String query26 = "CREATE TABLE `Decomm_Manage_Infra_Comp`(`seq_num` INTEGER (255) DEFAULT NULL, `prj_name` varchar(255) DEFAULT NULL, `app_name` varchar(255) DEFAULT NULL,`infra_comp_type` varchar(255) DEFAULT NULL,`comp_name` varchar(255) DEFAULT NULL,`managed_legacy` varchar(255) DEFAULT NULL,`server_app` varchar(255) DEFAULT NULL,`dev` varchar(255) DEFAULT NULL,`test` varchar(255) DEFAULT NULL,`stage` varchar(255) DEFAULT NULL,`prod` varchar(255) DEFAULT NULL,`retired` varchar(255) DEFAULT NULL,`comments` varchar(255) DEFAULT NULL)";
        statement.executeUpdate(query26);
        String query27 = "CREATE TABLE `Decomm_Manage_Service_Categories_Checklist`(`seq_num` INTEGER (255) DEFAULT NULL, `prj_name` varchar(255) DEFAULT NULL, `app_name` varchar(255) DEFAULT NULL, `options` varchar(600) DEFAULT NULL, `label_name` varchar(255) DEFAULT NULL, `column_name` varchar(255) DEFAULT NULL, `type` varchar(255) DEFAULT NULL, `mandatory` varchar(255) DEFAULT NULL, `value` varchar(255) DEFAULT NULL,`dev` varchar(255), `test` varchar(255), `stage` varchar(255), `prod` varchar(255),`comments` varchar(600))";
        statement.executeUpdate(query27);
        String query28 = "CREATE TABLE `Decomm_Manage_Service_Categories_Checklist_others`(`prj_name` varchar(255) DEFAULT NULL, `app_name` varchar(255) DEFAULT NULL,`others`varchar(255) DEFAULT NULL, `questions` varchar(600) DEFAULT NULL, `type` varchar(255) DEFAULT NULL,`value` varchar(600) DEFAULT NULL,`level` INTEGER(255) DEFAULT NULL, `sub_seq` INTEGER(255) DEFAULT NULL, `dev` varchar(255), `test` varchar(255), `stage` varchar(255), `prod` varchar(255), `comments` varchar(600)) ";
	...
	String query52 = "CREATE TABLE `ArchiveReq_Approver_Info` (`seq_no` INTEGER (255),`Id` varchar(255),`Field_id` INTEGER (255),`ROLE` varchar(255),`NAME` varchar(255),`TITLE` varchar(255),`APPROVER_PURPOSE` varchar(255) )";
        ...
        String query59 = "CREATE TABLE `Archive_Environment_Name_Info` (`seq_no` INTEGER (255),`OppId` varchar(255), `oppName` varchar(255), `prjName` varchar(255), `devName` varchar(255),`testName` varchar(255), `stageName` varchar(255), `prodName` varchar(255))";
        statement.executeUpdate(query59);
        
        String query60 = "CREATE TABLE `Archive_Environment_ServerIp_Info` (`seq_no` INTEGER (255),`OppId` varchar(255), `oppName` varchar(255), `prjName` varchar(255), `devServerIp` varchar(255),`testServerIp` varchar(255), `stageServerIp` varchar(255), `prodServerIp` varchar(255))";
        statement.executeUpdate(query60);
        
        String query61 = "CREATE TABLE `Archive_Retention_Template_Details` (`seq_no` INTEGER (255), `retentionCheck` varchar(255), `retentionLevel` varchar(255), `conditions` varchar(500), `dateUsedType` varchar(255), `dateUsed` varchar(255), `descp` varchar(500))";
        statement.executeUpdate(query61);
        
        String query62 = "CREATE TABLE `Archive_Retention_Info` (`seq_no` INTEGER (255),`OppId` varchar(255), `app_name` varchar(255), `prjName` varchar(255), `retentionCheck` varchar(255), `retentionLevel` varchar(255), `conditions` varchar(500), `dateUsedType` varchar(255), `dateUsed` varchar(255), `descp` varchar(500))";
        statement.executeUpdate(query62);
        
        String query63 = "CREATE TABLE `Archive_Retention_Content_Info` (`OppId` varchar(255), `app_name` varchar(255), `prjName` varchar(255), `contentInfo` varchar(2000))";
        statement.executeUpdate(query63);
        
        String query64 = "CREATE TABLE `ArchiveBussinessReq_Info` (`seq_no` INTEGER (255),`OppId` varchar(255), `app_name` varchar(255), `businessreq` varchar(2000))";
        statement.executeUpdate(query64);
        String query65 = "CREATE TABLE `ArchiveBussinessReq_Info_template_details` (`seq_no` INTEGER (255), `businessreq` varchar(2000))";
        statement.executeUpdate(query65);
        String query66 = "CREATE TABLE `BusinessReqinscope_Info` (`seq_no` INTEGER (255),`OppId` varchar(255),`prj_name` varchar(255), `OppName` varchar(255), `req_in_scope` varchar(255),`description` varchar(255))";
	...
	String query80 = "CREATE TABLE `Archive_DocumentRevision_Info` (`seq_no` INTEGER (255), `oppId` varchar(255), `oppName` varchar(255), `prjName` varchar(255), `date` varchar(255), `version` varchar(255), `documentChanges` varchar(255), `changeAuthor` varchar(255))";
	    ...
	    String query81 = "CREATE TABLE `Governance_Info_Template_Details` (`seq_no` INTEGER (255),`options` varchar(255),`label_name` varchar(255), `column_name` varchar(255),`type` varchar(255),`mandatory` varchar(255),`value` varchar(255))";
        statement.executeUpdate(query81);
    
        String query82 = "CREATE TABLE `Governance_Info_Details` (`seq_no` INTEGER (255), `waveId` varchar(255), `waveName` varchar(255), `prj_name` varchar(255), `options` varchar(255),`label_name` varchar(255), `column_name` varchar(255),`type` varchar(255),`mandatory` varchar(255),`value` varchar(255))";
        statement.executeUpdate(query82);
        
        String query83 = "CREATE TABLE `Governance_Info` (`seq_no` INTEGER (255), `waveId` varchar(255), `waveName` varchar(255), `prj_name` varchar(255), `options` varchar(255), `label_name` varchar(255), `column_name` varchar(255),`type` varchar(255),`mandatory` varchar(255),`value` varchar(255))";
        statement.executeUpdate(query83);
        
        String query84 = "CREATE TABLE `Archive_Req_Addendum_Info` (`seq_no` INTEGER (255),`oppId` varchar(255), `oppName` varchar(255), `prjName` varchar(255),`labelName` varchar(255), `addendumInfo` varchar(255))";
