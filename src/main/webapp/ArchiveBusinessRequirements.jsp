     ...
     <%@include file="Nav-Bar.jspf"%>
        ...
        <div class="col-md-12">
						...
						<div class="form-wizard-header">
							...
							<ul class="list-unstyled form-wizard-steps clearfix nav-font" style="margin-left:23px;" onclick="location.href='archiveReqAbbrevation.jsp';">
							<p class="nav-font" style="margin-bottom: -52px;">Fill all the required fields to go next step</p>
								...
								<li class="active"><span>4</span><i>Business requirements</i></li>
