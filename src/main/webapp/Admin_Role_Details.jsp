...
<link rel="stylesheet" href="css/archive_add/archive_add.css"
	media="screen">
...
@media ( min-width : 992px) .table-full-width {
	margin-left
	:
...
%>
	...
	<div class="main-wrapper">
		...
		<form class="form-signin" name="loginForm" method="post"
			action="Authorization_Role_details">
									...
									<div class="col-md-12">
										<div class="card">
											...
											<div class="header">
												...
												<p class="category">If the Module is restricted to a
													particular role, it is accessible by that role only.</p>
											...
											<div class="content table-responsive table-full-width">
												...
												<p>Note : (x = full access ; R = readonly ; N = no
													access)</p>
												<input type="hidden" id="rolecheck" value="<%= info %>"
													hidden> &nbsp;&nbsp;&nbsp;
												<button type="button" id="sub_btn"
													class="btn btn-primary pull-right" onclick="edit_serv()">Submit
												</button>
											</div>
										</div>
									</div>
