...
%>
 ...
 <ul class="nav navbar-nav navbar-right">
	...
	<li ><a href="#"><span id="nav_userid"><%=Encode.forJava(uname)%>&nbsp;</span>logged in as &nbsp;<span id='nav_role'><%=Encode.forJava(role)%></span></a></li>	
