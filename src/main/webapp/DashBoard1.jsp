				...
				<div class="row">
					...
					<div class="tabs-content">
						<ul class="nav navbar-nav navAlign">
							<li><a href="OpportunityList.jsp"><i
									class="fad fa-folders fa-2x iconAlign iconColor"></i>Applications</a></li>
							...
							<li class="active"><a href="#" style="color: #fff"><i
									class="fad fa-chart-pie iconAlign activeIcon fa-2x"></i>Dashboards</a></li>
							<li><a href="#"><i
