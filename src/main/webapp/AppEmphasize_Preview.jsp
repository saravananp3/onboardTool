                            ...
                            <div class="col-md-12">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row" id="panels1">
                                        ...
                                        <tr><a href="AppEmphasize_PrioritizedApplications.jsp" class="btn btn-success"
                                               class="btn pull-right"><span
                                                class="glyphicon glyphicon-download-edit"></span>Back</a>
                                            <button id="exportview" class="btn btn-primary"><span
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel" style="text-align: center"><b>List
                                                of
                                                Users</b></h4>
                                            <input type="checkbox" name="signorder" id="signorder" style="margin-left: -230px;">
