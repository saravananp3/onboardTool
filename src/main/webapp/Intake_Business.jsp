                                ...
                                %>
												...
												<div class="form-group">
													<label class="control-label" for="formInput198">
														...
														<button type="button" class="btn btn-success  pull-left">
															<a class="button" href="#popup1" id="P1">Add</a>
														</button> &nbsp;
                                    ...
                                    function edit_form(d1, Count_1) {
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a class="collapsed" data-toggle="collapse"
														...
														onclick="switchColors();">Legacy Retention Information</a>
												</h4>
											</div>
											<div id="collapse2" class="panel-collapse collapse">
												<div class="panel-body">
													...
													<button type="button" class="btn btn-default  pull-right"
														...
														<a class="collapsed" data-toggle="collapse"
															data-parent="#panels1" href="#collapse1"> <span
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a class="collapsed" data-toggle="collapse"
														...
														onclick="switchColors1();">Archive Data Management</a>
												</h4>
											</div>
											<div id="collapse3" class="panel-collapse collapse">
												<div class="panel-body">
													<button type="button" class="btn btn-success  pull-left">
														<a class="button" href="#popup3">Add</a>
													</button>
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<label class="control-label" for="formInput198">
															...
															<button type="button" class="btn btn-success  pull-left">
																<a class="button" href="#popup4">Add</a>
															</button>
										...
										<button type="button" class="btn btn-primary btn pull-right"
											onclick="validateform2();">Save & Continue...</button>
										&nbsp;
