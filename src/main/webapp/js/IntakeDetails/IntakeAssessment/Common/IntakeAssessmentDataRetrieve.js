               ...
               if(value.Mandatory=="Yes" && value.UMandatory=="Yes")
				...
				if (Type == "Text box") {
					...
					if (ColumnName == "StrucDBsize") {
						inputtext = inputtext + "<input type='number' pattern=' 0+.[0-9]*[1-9][0-9]*$' onkeypress='return event.charCode >= 48 && event.charCode <= 57' class='form-control' size='35' min='0' id='" + ColumnName + "' placeholder='' name='" + ColumnName + "' value='" + Value + "'/>\n" +
							"</div>";
					}
                ...
                else if(Type=="Dropdown")
                {
                    ...
                    for(var i=0;i<option.length;i++) {
                        ...
                        if(option[i]!==""){
                            inputdrop += "<option label=" + option[i] + " class='control-label' for= 'Assessment' " + select + ">" + option[i] + "</option>";
                            }
                            else{
                                inputdrop += "<option label=''class='control-label' for= 'Assessment' " + select + ">" + option[i] + "</option>";
                            }
                        }                   
