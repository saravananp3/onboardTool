	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	if(data.AddStatus){
            	 ...
            	 "<input type ='radio' name='"+section+(seqNum+1)+"' class='"+section+"InScope "+section+"Yes' value='Yes'  disabled /> Yes &nbsp;"+
            	 "<input type ='radio' name='"+section+(seqNum+1)+"' class='"+section+"InScope "+section+"No' value='No' disabled /> No"+
            	 "</td>"+
            	 "<td style='text-align:center;vertical-align: middle;'><input type='text' class='dataReq "+section+"ReqType' value='' readonly/></td>" +
            	 "<td style='text-align:center;vertical-align: middle;'>" +
            	 "<textarea rows='2' cols='40' style='height:100px;' class='req "+section+"Requirements' readonly></textarea>"+
            	 "</td>"+
            	 "<td style='text-align:center;vertical-align: middle;'>"+
            	 "<textarea class='additional "+section+"Additional' value='N/A' readonly>N/A</textarea>"+
            	 "</td>" +
            	 "<td style='text-align:center;vertical-align: middle;'>"+
            	 "<div class='col-md-4 dropdown'><img src='images/icons8-expand-arrow-25.png' class='dropdown-toggle' data-toggle='dropdown'></img>"+
                 "<ul class='dropdown-menu'>"+
                 "<li><a  class='fa fa-edit EditRow "+section+"Edit' style='font-size: 19px; color: black'>&nbsp;&nbsp;&nbsp;Edit</a></li>"+
