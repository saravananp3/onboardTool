...
function appendRowFunction(data){
    $.each(data, function(key, value){
        ...
        var row = "<tr>"+
                  ...
                  "</td>"+
                  "<td class='useraction' style='text-align:center;vertical-align: middle;display:block;'><span class='glyphicon glyphicon-pencil editpopup'id='editpopupabb"+seq_no+"'style='display:block;margin-left:-22px;'></span><span class='glyphicon glyphicon-trash deletepopup' style='float:right;display:block;margin-top:-13px;'></span>"+
                  "</td>"+                  
                  "</tr>";
