...
$(document).ready(function(){
    $.ajax({
        url: "FinanceDataRetrivalServlet",
        type: 'POST',
        dataType: "json",
              ...
              $('#TemplateFields').append(TemplateField);
                ...
                else if(Type=="Dropdown")
                {
                    ...
                    "</div>"+
                     ...
                     "</div>"+
        	         "<div class='col-md-6'>"+   
        	         "<select style = 'width:100%;' class ='form-select' id ='"+ColumnName+"_temp1' name='"+ColumnName+"_temp'>";
