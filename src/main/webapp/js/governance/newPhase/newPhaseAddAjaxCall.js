	                ...
	                if(data.AddStatus)
	               {
	                 ...
	                 if(data.Type=="Text box")
	                {
	                    var inputtext="<div class='form-group InputField'>"+
	                        "<label class='control-label' for='governance'><div "+required_field+">"+data.LabelName+delete_icon+"<span class='glyphicon glyphicon-pencil editpopup hidepencil' style='float:right;display:none;'></span></div></label>"+
	                ...
	                {
	                    var select="";
	                    select+= "<div class='form-group InputField'><label class='control-label' for= 'governance'><div "+required_field+">"+data.LabelName+delete_icon+"<span class='glyphicon glyphicon-pencil editpopup hidepencil' style='float:right;display:none;'></span></div></label>"+
