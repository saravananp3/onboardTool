												...
												<div class="card-body">
													...
													<form class="form-sample">
														...
														<div class="shadow p-3 mb-5 bg-white rounded">
                                                            ...
                                                            %>
																	<tr style="background-color: white;">
																		...
																		<td style="text-align: center;"><input
																			type="checkbox" name="chek"
																			onChange="selectCheck('<%=rs.getString(1) %>');"></td>
                                                            ...
                                                            %>
																	<tr
																		...
																		<td
																			style="text-align: center; background-color: white;"><input
																			type="checkbox" name="chek" id="chek"
														...
														<button type="button" id="add_btn" class="btn btn-primary"
															onclick="window.location.href='AdminModuleAddUser.jsp'"
                                                    ...
                                                    <button type="button" id="delete_button" name="delete_button"
														...
														<input type="button" id="del_btn" class="btn btn-primary"
															onclick="del(<%=count %>);" value="Delete User"
															style="margin: 5px"> &nbsp;&nbsp;
