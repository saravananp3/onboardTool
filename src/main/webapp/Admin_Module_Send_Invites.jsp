													...
													<form class="form-sample">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">First Name</div></label>
																	<div class="col-sm-9">
															...
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">Last Name</div></label>
																	<div class="col-sm-9">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">Email</div></label>
																	<div class="col-sm-9">
															...
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">Role Name</div></label>
																	<div class="col-sm-9">
																		<select id="dates-field2"
																			class="selectpicker multiselect-ui form-control"
																			data-show-subtext="true" data-live-search="true"
																			&lt;%&ndash;multiple="multiple"&ndash;%&gt;>
																			<option>ArchivalAdmin</option>
																			<option>LegacyTechnicalSME</option>
																			<option>LegacyBusinessSME</option>
																			<option>ArchivalProgramManager</option>
																			<option>ArchivalProjectManager</option>
																			<option>LegacyProgramManager</option>
																			<option>ArchivalBusinessAnalyst</option>
																			<option>ArchivalTechnicalLead</option>
																			<option>ArchivalDeveloper</option>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">Project</div></label>
																	<div class="col-sm-9">
																		<select
																			class="selectpicker multiselect-ui form-control"
															...
															<div class="col-md-6">
																<div class="form-group row">
																	<label class="col-sm-3 col-form-label"><div
																			class="required_fie">Applications</div></label>
																	<div class="col-sm-9">
																		<select
																			class="selectpicker multiselect-ui form-control"
																			id="projapp" name="projapp" data-live-search="true"
																			multiple="multiple">
																		</select>
																	</div>
																</div>
														...
														<div class="row">
															<div class="col-md-1">
																<input type="hidden" id="send_invites_id"
																	value="<%= info %>" hidden>
															...
															<div class="col-md-3">
																...
																<button type="button" class="btn btn-primary"
																	id="send_btn" onclick="send_email();">Send
																	Invites</button>
