 ...
 */
@WebServlet("/archiveReqDocRevDeleteServlet")
public class archiveReqDocRevDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public archiveReqDocRevDeleteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	archiveReqDocRevDeleteService deleteService = new archiveReqDocRevDeleteService(seqNum, ID);
        	jsonobject = deleteService.archiveReqDocRevDelete();
        	deleteService = null;
        	System.gc();
