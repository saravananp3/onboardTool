 ...
 */
@WebServlet("/archiveScreenReqDeleteServlet")
public class archiveScreenReqDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	archiveScreenReqDeleteService deleteService = new archiveScreenReqDeleteService(seqNum, ID, oppName);
        	jsonobject = deleteService.deleteScreenInfo();
        	deleteService = null;
        	System.gc();
