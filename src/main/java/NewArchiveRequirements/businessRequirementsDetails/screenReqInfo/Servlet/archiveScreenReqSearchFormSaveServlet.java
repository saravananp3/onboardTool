...
/**
 * Servlet implementation class archiveScreenReqSearchFormSaveServlet
 */
@WebServlet("/archiveScreenReqSearchFormSaveServlet")
public class archiveScreenReqSearchFormSaveServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			jsonObj=saveService.archiveFunctionalReqSearchFormSave();
			saveService = null;
			System.gc();
		}
		catch(Exception e)
