 ...
 */
 @WebServlet("/archiveReqIntroDataRetrieveServlet")
public class archiveReqIntroDataRetrieveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public archiveReqIntroDataRetrieveServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       archiveReqIntroDataRetrieveService archiveReqIntro;
		try {
			archiveReqIntro = new archiveReqIntroDataRetrieveService(Id);
			JsonObj = archiveReqIntro.archiveReqDataRetrieve();
