 ...
 */
@WebServlet("/archiveEnvironmentNameDataRetrieveServlet")
public class archiveEnvironmentNameDataRetrieveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public archiveEnvironmentNameDataRetrieveServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        archiveEnvironmentNameDataRetrieveService EnvmtName;
		
			try {
				EnvmtName = new archiveEnvironmentNameDataRetrieveService(Id, oppName);
				jsonArray = EnvmtName.archiveEnvmtDataRetrieve();
				EnvmtName =null;
				System.gc();
