package ArchiveExecution.Service;//package onboard;
...
public class Weekday {
    final static Logger logger = Logger.getLogger(Weekday.class);

    public static int actual_hours(String fromdate) {
