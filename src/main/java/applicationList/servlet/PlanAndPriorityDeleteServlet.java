...
import applicationList.service.PlanAndPriorityDeleteService;
@WebServlet("/PlanAndPriorityDeleteServlet")
public class PlanAndPriorityDeleteServlet extends HttpServlet { 
        ...
        protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try
            {
                ...
                PlanAndPriorityDeleteService service = new PlanAndPriorityDeleteService(OppId,id, jsonArray);
                jsonObj=service.planAndPriorityDelete();
                service = null;
                System.gc();
            }
            catch(Exception e)
