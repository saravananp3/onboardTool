...
@WebServlet("/Decomm_Intake_App_Servlet")
public class Decomm_Intake_App_Servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JsonArray infojson = new IntakeInformationService().decomm_intake_app(Project_name,Applications,ID,uname,roles);
