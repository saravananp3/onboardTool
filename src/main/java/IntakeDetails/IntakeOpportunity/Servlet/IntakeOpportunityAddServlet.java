...
public class IntakeOpportunityAddServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String select_lab = "select * from Opportunity_Info where Id = '"+ID+"' and label_name = '"+label_name+"' ";
            Statement st1=connection.createStatement();
            ResultSet rs1=st1.executeQuery(select_lab);
            String select_col = "select * from Opportunity_Info where Id = '"+ID+"' and column_name = '"+column_name+"' ";
