...
public class IntakeTriageAddServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String select_lab = "select * from Triage_Info where Id = '"+ID+"' and label_name = '"+label_name+"' ";
            ...
            if(!labelcheck)
            {
            int seq_num =new IntakeTriageService().Add(ID,label_name, mandatory, type, NumberofInputfields, option);
