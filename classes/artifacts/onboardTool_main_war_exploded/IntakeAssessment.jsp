...
<script
	src="js/IntakeDetails/IntakeAssessment/Common/IntakeAssessmentDataRetrieve.js"></script>
...
<body class="top-navbar-fixed">
			...
			<div class="row" id="d3s-mt-10">
				<div class="col-lg-12 col-md-12">
					<div class="sub-title" style="color: #fff">
						...
						>> <a href="IntakeOpportunity.jsp" id="sitetitle1"
							style="color: #fff">Opportunity</a> >> <a href="IntakeTriage.jsp"
							id="sitetitle1" style="color: #fff">Triage</a> >> <a
							href="IntakeTriageSummary.jsp" id="sitetitle1"
							style="color: #fff">TriageSummary</a> >>Assessment
					</div>
				</div>
			</div>
		</div>
	...
	<div class="main-wrapper">
      ...
      <nav class="navbar navbar-down">
									...
									<form action="" method="post" role="form">
															...
															<div class="panel-body">
																<div id="inputFieldsAssessment">
																	...
																	<div class="accordion"
																		...
																		<div class="accordion-item">
																			<h2 class="accordion-header"
																				...
																				<button class="accordion-button"
																					...
																					aria-expanded="true"
																					aria-controls="panelsStayOpen-collapseOne">Application
																					Information</button>
																			</h2>
																		...
																		<div class="accordion-item">
																			<h2 class="accordion-header"
																				...
																				<button class="accordion-button collapsed"
																					...
																					aria-expanded="false"
																					aria-controls="panelsStayOpen-collapseTwo">Data
																		...
																		<div class="accordion-item">
																			<h2 class="accordion-header"
																				...
																				<button class="accordion-button collapsed"
																					...
																					aria-expanded="false"
																					aria-controls="panelsStayOpen-collapseThree">Compliance
																					Characteristics</button>
																			</h2>
																		...
																		<div class="accordion-item">
																			<h2 class="accordion-header"
																				...
																				<button class="accordion-button collapsed"
																					...
																					aria-expanded="false"
																					aria-controls="panelsStayOpen-collapseFour">Archival
																					Consumption</button>
																			</h2>
																		...
																		<div class="accordion-item" id="ContractInformation"
																			style="display: none;">
																			<h2 class="accordion-header"
																				...
																				<button class="accordion-button collapsed"
																					...
																					aria-expanded="false"
																					aria-controls="panelsStayOpen-collapseFive">Contract
																					Information</button>
																			</h2>
                                      ...
                                      <a href="javascript:;" class="form-wizard-next-btn float-right btn btn-info" onclick="location.href='IntakeStakeHolder.jsp';">Next</a>  
                                       ...
                                       <button type="button" class="btn btn-primary pull-right" id="OpportunityListbtn" onclick ="window.location.href='IntakeDetails.jsp';"style="display:none;"></button>
																			...
																			<div class="col-8" align="end">
																				...
																				<div class="dropdown">
																					...
																					<ul class="dropdown-menu"
																						...
																						<li><a class="dropdown-item dropDown-font"
																							id="EditAssess" href="#"><i
																								class="fas fa-edit" aria-hidden="true">&nbsp;&nbsp;</i>Edit</a></li>
																						<li><a class="dropdown-item dropDown-font"
																							id="DeleteAssess" href="#"><i
																								class="fas fa-trash" aria-hidden="true">&nbsp;&nbsp;&nbsp;</i>Delete</a></li>
										...
										<div class="modal fade triage-example-modal-lg"
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<button type="button" class="close"
															id="triage_temp_close_id" data-dismiss="modal"
															aria-label="Close">
															<span aria-hidden="true">&times;</span>
														</button>
													</div>
													...
													<div class="modal-footer">
														...
														<button type="button"
															class="btn btn-primary submitDisable"
															onclick="validateTriage()">Add Template</button>
													</div>
												</div>
											</div>
										</div>
										<!-- Triage Ssummary Template modal-->
										<div class="modal fade triage-summary-example-modal-lg"
											id="myFormModal" tabindex="-1" role="dialog"
											aria-labelledby="myLargeModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<button type="button"
															...
															onclick="validateTriageSummary()">Add Template</button>
													</div>
												</div>
											</div>
										</div>
										<div class="modal" id="EditPopUp" tabindex="-1"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header"
														...
														<h5 class="modal-title" id="exampleModalLabel"
															style="color: white;">Application Information
															Screenshots</h5>
											...
											<input type="submit" id="deletegrid_update"
												style="display: none;">
						...
						<div class="modal" id="AddTriagePopUp" tabindex="-1" role="dialog">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Add Input Fields</h5>
										<button type="button" class="close" id="add_Triage_close_id"
											data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
											...
											<div id="scrollbar">
												<div class="row">
													<div class="form-group">
														<div class="col-lg-8">
															<label class="control-label" for="formInput526">Label:</label>
															<input type="text" class="form-control" id="Triagelabel"
																name="label" required>
														</div>
													</div>
												</div>
												<br /> <input type="hidden" id="Triage_project_name"
													name="project_name" value=""> <input type="text"
													id="Triage_appln_name" name="appln_name" value=""
													style="display: none;"> <input type="text"
													id="Triage_servlet_name" name="servlet_name" value=""
													style="display: none;">
                            ...
                            <input type="text" class="form-control" id="Triageidname"  name="idname" required>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-lg-8">
															<label class="control-label" for="formInput526">Type:</label>
															<select id="Triagetypes" class="form-select" name="types"
																required>
																<option value="Text box">Text box</option>
																<option value="Check box">Check box</option>
																<option value="Radio box">Radio box</option>
												...
												<div class="row TriageHideField" id="TriageCheck"
													...
													<div class="form-group">
														<div class="col-sm-4">
															<label class="control-label" for="formInput526">Number
																of check boxes:</label> <input type="text" class="form-control"
																id="TriageNumber" name="TriageNumber">
														</div>
													</div>
													<br />
												</div>
												<div class="row TriageHideField" id="TriageRadio"
													...
													<div class="form-group">
														<div class="col-sm-4">
															<label class="control-label" for="formInput526">Number
																of Radio boxes:</label> <input type="text" class="form-control"
																id="TriageRadioNumber" name="TriageRadioNumber">
														</div>
													</div>
													<br />
												</div>
						...
						<div class="modal" id="TiageSummAddPopUp" tabindex="-1"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Add Input Fields</h5>
										<button type="button" class="close" id="TriageSummAddCloseId"
											data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-lg-8">
															...
															<input type="text" class="form-control" id="TriSummLabel"
																name="TriSummLabel" required>
														</div>
													</div>
												</div>
												<br /> <input type="hidden" id="project_name"
													...
													<div class="form-group">
														<div class="col-sm-4">
															<label class="control-label" for="TriageSummary">Number
																of check boxes:</label> <input type="text" class="form-control"
																id="TriSummNumber" name="TriSummNumber1">
														</div>
													</div>
													<br />
												</div>
												<div class="row hidefield" id="TriSummRadio"
													...
													<div class="form-group">
														<div class="col-sm-4">
															<label class="control-label" for="TriageSummary">Number
																of Radio boxes:</label> <input type="text" class="form-control"
																id="TriSummRadioNbr" name="TriSummRadioNbr">
														</div>
													</div>
													<br />
												</div>
											...
											<div id="scrollbar">
												...
												<div class="row">
													<div class="form-group-popup">
														<div class="col-lg-12">
															<label class="control-label" for="formInput526">Label:</label>
															<input type="text" class="form-control" id="AssessLabel"
																name="AssessLabel" required>
														</div>
													</div>
												</div>
												<input type="hidden" id="project_name" name="project_name"
													value=""> <input type="text" id="appln_name"
													name="appln_name" value="" style="display: none;">
												<input type="text" id="servlet_name" name="servlet_name"
                    ...
                    <div class="form-group">
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" id="idname"  name="idname" required>
												...
												<div class="row AssessHideField" id="AssessCheck"
													...
													<div class="form-group-popup">
														<div class="col-lg-12">
															<label class="control-label" for="formInput526">Number
																of check boxes:</label> <input type="text" class="form-control"
																id="AssessCheckNumber" name="AssessCheckNumber1">
														</div>
													</div>
												...
												<div class="row AssessHideField" id="AssessRadio"
													...
													<div class="form-group-popup">
														<div class="col-lg-12">
															<label class="control-label" for="formInput526">Number
																of Radio boxes:</label> <input type="text" class="form-control"
																id="AssessRadioNumber" name="AssessRadioNumber">
														</div>
													</div>
												...
												<div class="col-lg-12" id="AssessOptions"></div>
						...
						<div class="modal" id="DeleteTriagePopUp" tabindex="-1"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Delete Field</h5>
										<button type="button" id="TriageDeleteClose" class="close"
											data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
						...
						<div class="modal" id="TriageSummaryDeletePopUp" tabindex="-1"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Delete Field</h5>
										<button type="button" id="TriSummDeleteClose" class="close"
											data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
						...
						<div class="modal" id="EditTriagePopUp" tabindex="-1"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Edit Input Field</h5>
										<button type="button" id="TriageEditClose" class="close"
											data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form name="PopUpform">
											...
											<br /> <input type="text" id="AssessSeqNum" name="" value=""
												style="display: none;"> <input type="text"
		...
		<!-- Modal -->
		<div class="modal fade" id="myModal modal" tabindex="-1" role="dialog"
				...
				<div id="modal-content">
					<div class="modal-header">
						...
						<input type="checkbox" name="signorder" id="signorder"
							style="margin-left: 245px;"> <b>Set signing order</b> <input
							class="searchbox" id="search_bar" type="text"
							placeholder="Search User" name="search" style="font-size: 15px" />
					</div>
	...
	<button type="button" class="btn btn-primary"
		id="intake_scr_delete_popup" data-bs-toggle="modal"
		data-bs-target="#IntakeSCRDeletePopUp" style="display: none;"></button>
	...
	<!-- Intake Assessment -->
	<script
		src="js/IntakeDetails/IntakeAssessment/ApplicationInformation/ApplicationDetailsFieldFunctionality.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/AssessmentAddAjaxCall.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/AssessmentAddFunctionality.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/EditDeleteToggle.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/AssessEditDeleteAjaxCall.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/IntakeAssessmentSave.js"></script>
	...
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/Intake_Scr_Retrieve.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/Intake_Scr_Download.js"></script>
	<script
		src="js/IntakeDetails/IntakeAssessment/Common/Intake_Scr_Delete.js"></script>
